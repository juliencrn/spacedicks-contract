import { starsAroundTheHead } from './singleLayers'
import { femaleCycloid, maleCycloid, smallEyes, smallEyesMakeup, smallMaleCycloid } from './eyes'
import { Accessory } from '../types'

export const cuteHairBelow: Accessory = {
...
export const cuteHairCornBelow: Accessory = {
...
export const hats: Accessory[] = [
	...
	},
	{
		...
		children: [cuteHairBelow, smallEyes],
		defs: ["green-pink-purple-45"]
	},
	{
		name: "Cute hair corn",
